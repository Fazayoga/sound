...
@section('admincontent')
    <div class="wrapper">
        ...
        <table border="1">
            ...
            @forelse($testi as $test)
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('testi.destroy', $test->id) }}" onsubmit="return confirm('Are you sure you want to delete this testimonial?')">
                            @csrf
                            @method('DELETE')
            ...
            @empty
                <tr>
                    <td colspan="4">Tidak ada data Testimoni.</td>
                </tr>
            @endforelse
        </table>
    </div>
